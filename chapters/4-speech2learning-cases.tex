...
A pesquisa documental foi conduzida a partir de uma revisão complementar da literatura. Esses materiais foram analisados com o objetivo de mapear padrões, identificar lacunas na pesquisa existente e estabelecer diretrizes teóricas relevantes para tecnologias de ASR e STT voltadas à acessibilidade educacional. Nesse contexto, a análise documental seguiu os princípios propostos por \citeonline{LimaJunior2021}, que enfatizam a importância de um percurso metodológico bem estruturado para assegurar a robustez dos resultados obtidos.
...
Os resultados, estratificados por idioma, reforçaram essas descobertas ao evidenciar diferenças significativas na avaliação das transcrições automáticas entre os provedores em todos os grupos de idiomas. Isso indica que a qualidade percebida pelos participantes é influenciada não apenas pelo provedor, mas também pelo idioma, evidenciando os desafios de oferecer transcrições de alta qualidade de maneira consistente em diferentes contextos linguísticos (\autoref{table:c4:results-survey-by-lang-tests}).
...
\citeonline{Alshaikh2024} exploraram a integração da IAGen na educação por meio do desenvolvimento e avaliação de um Assistente de Vídeo Educacional com IA. Baseado na Teoria Cognitiva da Aprendizagem Multimídia (CTML), o ferramental combina módulos de Transcrição, Engajamento e Reforço, utilizando tecnologias ASR para enriquecer a experiência de aprendizagem. Ao destacar experiências multimodais, o estudo demonstra como técnicas avançadas de IA, incluindo STT, podem aprimorar os resultados educacionais.
...
Com base nessa abordagem integrada, foi possível categorizar os estudos em quatro grandes temas, que sintetizam de maneira abrangente as principais contribuições dos trabalhos analisados para o campo das tecnologias ASR/STT:
