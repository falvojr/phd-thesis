...
\textoresumo[brazil]{
    TODO. 
    }{Arquitetura de Software, Reconhecimento Automático de Fala, Objetos de Aprendizagem, Acessibilidade Digital, Estudos de Caso.}
...
\textoresumo[english]{
    TODO. 
    }{Software Architecture, Automatic Speech Recognition, Learning Objects, Digital Accessibility, Case Studies}
...
\chapter{Survey Transcrição Automática de Videoaulas}
